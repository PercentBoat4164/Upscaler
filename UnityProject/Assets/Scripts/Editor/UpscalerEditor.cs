...
public class UpscalerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        else
        {
            ...
            _message = "Upscaling encountered an Error. Fell back to the 'None' Upscaler.";
        }
        ...
        if (_basicSettingsFoldout)
        {
            ...
            EditorGUILayout.PropertyField(_upscalerType, new GUIContent("Upscaler",
                "Choose an Upscaler to use.\n" +
                "\nUse None to completely disable upscaling.\n" +
                "\nUse DLSS to enable DLSS upscaling."));
            EditorGUILayout.PropertyField(_qualityMode, new GUIContent("Quality",
