...
namespace Conifer.Upscaler.Scripts
{
     ...
     *
     * <remarks>Obtain an instance of this class using <see cref="Conifer.Upscaler.Scripts.Upscaler.QuerySettings"/>.
     * Check the values, or make your changes then apply them using
     * <see cref="Conifer.Upscaler.Scripts.Upscaler.ApplySettings"/>.</remarks>
     *
     * <example><code>
    ...
    public class Upscaler : MonoBehaviour
    {
        ...
        /// resolution, or by querying the upscaler. It is only ever (0, 0) when the upscaler has a <see cref="Status"/>
        /// error or the upscaler is <see cref="Conifer.Upscaler.Scripts.Settings.Upscaler.None"/>.
        ...
        /// This only applies when the upscaler is not <see cref="Conifer.Upscaler.Scripts.Settings.Upscaler.None"/>.
         ...
         * upscaler to the default <see cref="Conifer.Upscaler.Scripts.Settings.Upscaler.None"/>.</remarks>
         *
        ...
        protected void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            UpscalingData.BlitDepth(upscale, source, UpscalingData.SourceDepthTarget);
            Plugin.Upscale(upscale, source, UpscalingData.SourceDepthTarget, Shader.GetGlobalTexture(MotionID), outputColor);
            if (!destination)
                upscale.Blit(outputColor.colorBuffer, destination);
            else
                UpscalingData.BlitDepth(upscale, UpscalingData.SourceDepthTarget, destination.depthBuffer);
