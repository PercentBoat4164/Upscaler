...
namespace Conifer.Upscaler.Scripts.impl
{
    public class Universal : RenderPipeline
    {
        ...
        public override bool ManageMotionVectorTarget(Upscaler.UpscalerMode upscalerMode, Vector2Int resolution)
        {
            return _upscalerRendererFeature.ManageMotionVectorTarget(upscalerMode, resolution);
        }

        public override bool ManageInColorTarget(Upscaler.UpscalerMode upscalerMode, Vector2Int resolution)
        {
