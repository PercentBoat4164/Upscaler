...
namespace Conifer.Upscaler
{
    ...
    public class Upscaler : MonoBehaviour
    {
        ...
        public enum Status : uint
        {
            ...
            /// The current upscaler does not support the current Graphics API. This error can be avoided by performing a call to <see cref="Upscaler.IsSupported"/> beforehand.
