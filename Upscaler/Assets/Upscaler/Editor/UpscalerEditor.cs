...
namespace Upscaler.Editor
{
    ...
    public class UpscalerEditor : UnityEditor.Editor
    {
        ...
        {
            advancedSettingsFoldout = EditorPrefs.GetBool("Upscaler:advancedSettingsFoldout", false);
            debugSettingsFoldout = EditorPrefs.GetBool("Upscaler:debugSettingsFoldout", false);
            betaSettingsFoldout = EditorPrefs.GetBool("Upscaler:betaSettingsFoldout", false);
            ...
            icon.LoadImage(File.ReadAllBytes(Application.dataPath + "/Upscaler/Editor/Logo.png"));
            EditorGUIUtility.SetIconForObject(serializedObject.targetObject, icon);
        }

        private void OnDisable()
        {
            EditorPrefs.SetBool("Upscaler:advancedSettingsFoldout", advancedSettingsFoldout);
            EditorPrefs.SetBool("Upscaler:debugSettingsFoldout", debugSettingsFoldout);
            EditorPrefs.SetBool("Upscaler:betaSettingsFoldout", betaSettingsFoldout);
        }
