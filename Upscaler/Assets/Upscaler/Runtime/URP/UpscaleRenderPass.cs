...
namespace Upscaler.Runtime.URP
{
    public partial class UpscalerRendererFeature
    {
        public class UpscaleRenderPass : ScriptableRenderPass
        {
            ...
            private static void ExecuteUpscalePass(UpscaleData passData, UnsafeGraphContext context)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                using var builder = renderGraph.AddUnsafePass("Upscaler | Upscale", out UpscaleData data);
                ...
                builder.SetRenderFunc((UpscaleData passData, UnsafeGraphContext context) => ExecuteUpscalePass(passData, context));
